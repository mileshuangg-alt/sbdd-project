...
| 010 | 2026-08-28 | Complete the preregistered Graves/DOCK negative-control program, establish experimentally supported human-A2A negatives, and advance the blinded Stage-5 discrimination panel | ✅ Complete — Graves geometric-decoy ladder closed as a preregistered null; one independent DOCK negative qualified; second unrelated generator family remains before blind ProLIF POD |
| 011 | 2026-09-02 to 2026-09-06 | Qualify rDock as the second unrelated negative pose-generation lineage, freeze the experimental-negative panel, and execute the blind frozen-ProLIF proof-of-discrimination | ✅ Complete — rDock P1-qualified; panel frozen before ProLIF exposure; one experimental hA2A-negative molecule failed the frozen A2A recognition pattern under both DOCK and rDock poses; molecule-level discrimination established at this evidence scope |
