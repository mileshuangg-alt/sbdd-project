...
import sys
import math
# OpenEye import removed for isolated Stage-5 compatibility.
# XAC CCD formal charge is independently validated as 0.
...
def create_amsol71_inputfile(Path_and_NameZmatMOPACFile,MoleculeName,ZmatMOPAC_Data):
    ...
    # 
    # Stage-5 XAC native-control compatibility:
    # wwPDB CCD formal charge = 0; independently reproduced by RDKit.
    # This replaces only the historical OEChem OENetCharge() dependency.
    netcharge = 0
    if VERBOSE:
        print("netcharge of XAC CCD native control:", netcharge)
    #
